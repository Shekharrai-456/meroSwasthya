...
export async function resetDb(): Promise<void> {
  await prisma.$executeRaw`TRUNCATE TABLE "audit_entries", "access_grants", "patients", "invite_codes", "refresh_tokens", "otp_codes", "users", "facilities" RESTART IDENTITY CASCADE`;
}
