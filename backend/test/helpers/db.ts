...
export async function resetDb(): Promise<void> {
  await prisma.$executeRaw`TRUNCATE TABLE "sync_ops", "audit_entries", "access_grants", "reminders", "mock_sms", "deliveries", "anc_contacts", "pregnancies", "visits", "patients", "codelist_items", "invite_codes", "refresh_tokens", "otp_codes", "users", "facilities" RESTART IDENTITY CASCADE`;
}
